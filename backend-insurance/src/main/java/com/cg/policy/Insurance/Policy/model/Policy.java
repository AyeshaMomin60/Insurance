...
public class Policy {
	...
	private Double detuctableAmount;
	@Column(name = "Details")
	...
	public Policy(int planId, String name, Double cost, Double detuctableAmount, String details, boolean deleted) {
		super();
		this.planId = planId;
		this.name = name;
		this.cost = cost;
	...
	public Double getDetuctableAmount() {
		return detuctableAmount;
	}

	public void setDetuctableAmount(Double detuctableAmount) {
		this.detuctableAmount = detuctableAmount;
	}
